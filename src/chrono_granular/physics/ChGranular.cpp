...
void ChSystemGranularSMC::writeContactInfo(std::string ofile) const {
    ...
    outstrstream << "bi,bj,Fn,Ft1,Ft2,Ft3\n";
...
void ChSystemGranularSMC::setParticlePositions(const std::vector<float3>& points,
